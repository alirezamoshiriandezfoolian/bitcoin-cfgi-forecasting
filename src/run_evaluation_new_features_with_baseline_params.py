...
from evaluate_model_with_params_price_new_features import evaluate_model_with_params
...
for rank, config in enumerate(configs, start=1):
    ...
    model_name = f"best_model_CFGI_new_features_final_{rank}"

    print("\n======================================")
    print(
        f"Running baseline rank {rank}/5 "
        f"(Optuna Trial {trial_number}) on CFGI-derived-features model"
    )
    print("======================================")
...
print("\n======================================")
print("ALL FIVE NEW-FEATURE EVALUATIONS WITH BASELINE PARAMETERS COMPLETED")
print("======================================")
